...
class c1_Introduction : IntroductionBase() {
    ...
    fun unresponsive_service() {
        val exception: Exception = Assertions.assertThrows(IllegalStateException::class.java) {
    ...
    fun fortune_top_five() {
        ...
        Assertions.assertEquals(Arrays.asList("Walmart", "Amazon", "Apple", "CVS Health", "UnitedHealth Group"), results)
    ...
    fun nothing_happens_until_you_() {
        ...
        Assertions.assertEquals(Arrays.asList("Walmart", "Amazon", "Apple", "CVS Health", "UnitedHealth Group"), companyList)
    }
