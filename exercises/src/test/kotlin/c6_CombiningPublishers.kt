...
//        getUserEmail(null) todo: Uncomment this
    ...
    fun instant_search() {
        //todo: feel free to change code as you need
//        autoComplete(null) todo: Uncomment this
    ...
    fun acid_durability() {
        ...
        tasksToExecute()
//        commitTask(null) todo: Uncomment this
    ...
    fun car_factory() {
        ...
        StepVerifier.create(producedCars!!)
            .recordWith { ConcurrentLinkedDeque() }
            .expectNextCount(3)
            .expectRecordedMatches { cars: Collection<Car> ->
                cars.stream()
                    .allMatch { (chassis, engine): Car -> chassis.seqNum == engine.seqNum }
            }
            .verifyComplete()
    }
